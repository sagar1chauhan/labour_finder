...
const AdminHeader = ({ onMenuClick }) => {
  ...
  const getPageInfo = (pathname) => {
    const mappings = [
      ...
      { path: '/admin/vendors', title: 'Vendors', description: 'Manage vendor registrations and details' },
      { path: '/admin/workers/all', title: 'All Workers', description: 'Manage platform workers and their activity' },
      { path: '/admin/workers/analytics', title: 'Worker Analytics', description: 'Analyze worker activity trends' },
      ...
      { path: '/admin/payments/revenue', title: 'Admin Revenue', description: 'Track platform income' },
